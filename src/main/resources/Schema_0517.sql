...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`trail` (
  ...
  `start_sido_code` INT NULL,
  `start_gugun_code` INT NULL,
  `end_name` VARCHAR(45) NULL,
  `end_sido_code` INT NULL,
  `end_gugun_code` INT NULL,
  `route` TEXT NULL,
  `tel` VARCHAR(45) NULL,
  `manage_name` VARCHAR(45) NULL,
  `add_date` VARCHAR(45) NULL,
  `provide_code` INT NULL,
  `provide_name` VARCHAR(45) NULL,
  `start_detail` VARCHAR(45) NULL,
  `end_detail` VARCHAR(45) NULL,
  `recomend` INT NULL,
...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`trail_board` (
  ...
  `trail_board_title` VARCHAR(45) NULL,
  `trail_board_content` TEXT NULL,
  `trail_board_start_time` TIMESTAMP NULL,
  `trail_board_end_time` TIMESTAMP NULL,
  `trail_board_create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `trail_board_trail_id` INT NULL,
