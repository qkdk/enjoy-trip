            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="clearfix align-content-center">
                        ...
                        <p>
                            <span class="fw-bold">작성자 : ${place.userId}</span> <br/>
                            <span class="text-secondary fw-light"> 작성일 : ${place.placeCreateTime}
								</span>
                ...
                <div> 
                <img alt="picture" src="${root}/upload/${place.placeImgSrc}" width="500">
                </div>
