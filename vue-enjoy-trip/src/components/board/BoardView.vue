          ...
          <div class="row">
            <div class="col-md-8">
              <div class="clearfix align-content-center">
                ...
                />
                <p>
                  <span class="fw-bold">작성자 : {{ notice.userId }}</span>
                  <br />
                  <span class="text-secondary fw-light">
                    작성일 : {{ notice.noticeCreateTime }}
                  </span>
                  <span class="text-secondary fw-light">
                    조회 : {{ notice.noticeHit }}
                  </span>
            ...
            <div class="d-flex justify-content-end">
              <router-link to="/board/list" class="btn btn-outline-primary mb-3"
                >글목록
              </router-link>
              <button
                type="button"
...
export default {
  ...
  methods: {
    ...
    deleteBoard() {
      ...
      console.log(this.no);
      fetch(
        "http://localhost:8080/enjoytrip/notice/api/delete?noticeNo=" + this.no,
        requestOptions
      )
